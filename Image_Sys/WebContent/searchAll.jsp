...
<br><br><br>
<form  action="all" name="search" ><table cellpadding="10" cellspacing="10" border="05">
...
<div id="searching" style="display : none"><table cellpadding="10" cellspacing="10" border="05">
...
<div id="searchingdate" style="display : none"><table cellpadding="10" cellspacing="10" border="05">


<tr><td>Enter date in (mm-dd-yyyy) format :</td><td>
        
        <input type="Text" id="date1" name="date1" maxlength="25" size="25"/>
        <img src="C:\Users\user\Desktop\Image_Sys\cal.jpg" onclick="javascript:NewCssCal('date1')" style="cursor:pointer" height="20"/></td>
    </tr><tr><td>Enter date in (mm-dd-yyyy) format : </td><td><input type="Text" id="date2" name="date2" maxlength="25" size="25"/>
        <img src="C:\Users\user\Desktop\Image_Sys\cal.jpg" onclick="javascript:NewCssCal('date2')" style="cursor:pointer" width=20/></td></tr><tr><td><input type="submit" value="search by date"></td></tr>
</table>
</div>
